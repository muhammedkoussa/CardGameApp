...
public class ListFragment extends Fragment {
    ...
    //list olarak scoreTableList gönderdik
    public ListFragment(List<ScoreTable> scoreTableList){
        this.scoreTableList = scoreTableList;
    }

    @Override//fragment oluşturulduğu zaman çalışan fonksiyon
    ...
    public  void loadData(List<ScoreTable> scoreTableList){//list alıp recyclerView de gösterir.
