...
//preferencleeri otomatik kaydeden sınıf

public class SettingsFragment extends PreferenceFragmentCompat {

    private PreferenceClass preferences;// preferenceclass nesneyi üretip onun üzerinden kontrol ediyor.
...
//ayarlardaki değişiklikleri tek tek kontrol edip uygulamaya yansıtıyor.
    ...
    public void RegisterEventHandlers () {
        ...
        clearDatabase.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
            ...
            public boolean onPreferenceChange(@NonNull Preference preference, Object newValue) {
                ...
                new AsyncTask<Void,Void,Void>(){
                    ...
                    }.execute();// yarım saniye bekletip switchi geri çekiyor
                return true;
            }
        });
        ...
        scores.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
            ...
            public boolean onPreferenceChange(@NonNull Preference preference, Object newValue) {
                ...
                }.execute();//skorlar switchine tıklandıgında fragment değişimi için ryclerview list fragmenti geliyor
                return true;
            }
        });
