...
//bu sınıfta imageview sınıfının içinde idsi var eşleştirme name i var zorluk seviyesi için imageviwei var.
// bu imageviwe i arayüzde gösteriyoruz iki tane drawble var açık kapalı, kapalı iken simgeler farklı.
public class Cards {
    ...
    public Cards() {}
    //ayrı ayarı oluşturmaya yarar cardgameden üret.
    ...
    // animate fonksiyonu ilgili kartın imagei çeviriryo 360 derece çevirip simgesini değişitiryor.
    //  drawblei paramter alıyor açık yada kapalı olma durumu için
