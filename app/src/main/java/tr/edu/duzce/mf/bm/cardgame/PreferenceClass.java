...
//SharedPreferences oluşturup bunu setting fragmentin oluşturdugu preferences dolduruyor alıyor.
...
public class PreferenceClass  {
    ...
    public PreferenceClass(Context context) {
        ...
        InitComponents();// bu fonksiyon preference alıp oluşturuyor.
        NotifyChanges(); //bu fonksiyonu çağırıdaımzda preferencta kaydedilenlerin son halini alıp uygulamaya yansıtıyorr.

    }
    // iki tane media player oluşturyıe müzikve effect için
...
// bu fonksiyonu çağırıdaımzda preferencta kaydedilenlerin son halini alıp uygulamaya yansıtıyor.
...
// switch kapalı mı sliderin değeri switch kapalıysa müziği durduruyor
...
// switch kapandığında slider ile oynayamayıaz
...
//kartın simegelerini değiştiryo pc mi okul mu araç mı
