...
public class ScoreTableRecyclerAdapter extends RecyclerView.Adapter<ScoreTableRecyclerAdapter.ScoreTableViewHolder> {
    ...
    public ScoreTableRecyclerAdapter(List<ScoreTable> scoreTableList){//burası constructor
        this.scoreTableList = scoreTableList;
    }
// gösterilecek olan liseti arayüzdeki xml ile bağlantısını yapar
    ...
    // alttakiler ryclerviewin fonksiyonları
    //onCreateViewHolder göstericek satırı bana döndüüryor.
    //onBindViewHolder gösterilecek satırların içeriğini yerleştiiryor.
    @NonNull
    @Override
