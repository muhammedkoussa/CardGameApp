...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        callFragment(getSupportFragmentManager(), new MainPageFragment());//ilk açıldığında MainPageFragment ekrana geliyor.
    ...
    protected void onResume() {
        super.onResume();
        preferenceClass.NotifyChanges();//ayarları kontrol ediyor.
    }

    @Override
    protected void onStop() {
        super.onStop();
        preferenceClass.setMusic(false, 0);// müziği kapatıyor.
        preferenceClass.setEffect(false, 0);//efekt sesini kapatıyor
    }
